...
🚨 **EMERGENCY:** For medical emergencies, call **112** immediately (Indonesia Emergency Number)

💡 **Note:** This information is for reference only. For emergencies, always call 112 first before going to any hospital."""
...
hospital_finder_agent = LlmAgent(
    ...
    description=(
        ...
        "Provides hospital information including addresses, phone numbers, ratings, and hours for Indonesia."
    ),
